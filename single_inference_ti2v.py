...
if __name__ == "__main__":
    ...
    parser.add_argument("--vae", type=str, default='/cluster/scratch/lcattaneo/Allegro/vae')
    parser.add_argument("--dit", type=str, default='/cluster/scratch/lcattaneo/Allegro/transformer')
    parser.add_argument("--text_encoder", type=str, default='/cluster/scratch/lcattaneo/Allegro/text_encoder')
    parser.add_argument("--tokenizer", type=str, default='/cluster/scratch/lcattaneo/Allegro/tokenizer')
    parser.add_argument("--save_path", type=str, default="/cluster/scratch/lcattaneo/output_videos/test_video.mp4")
